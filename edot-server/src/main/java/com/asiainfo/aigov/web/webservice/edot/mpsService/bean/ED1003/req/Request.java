...
package com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1003.req;
...
public class Request implements java.io.Serializable {
    ...
    private java.lang.String _appoint_Start_Date;

    private java.lang.String _appoint_End_Date;
    ...
    public Request() {
        super();
    } //-- com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1003.req.Request()
    ...
    /**
     * Returns the value of field 'appoint_End_Date'.
     * 
     * @return the value of field 'appoint_End_Date'.
    **/
    public java.lang.String getAppoint_End_Date()
    {
        return this._appoint_End_Date;
    } //-- java.lang.String getAppoint_End_Date() 

    /**
     * Returns the value of field 'appoint_Start_Date'.
     * 
     * @return the value of field 'appoint_Start_Date'.
    **/
    public java.lang.String getAppoint_Start_Date()
    {
        return this._appoint_Start_Date;
    } //-- java.lang.String getAppoint_Start_Date() 
    ...
    **/
    ...
    /**
     * Sets the value of field 'appoint_End_Date'.
     * 
     * @param appoint_End_Date the value of field 'appoint_End_Date'
    **/
    public void setAppoint_End_Date(java.lang.String appoint_End_Date)
    {
        this._appoint_End_Date = appoint_End_Date;
    } //-- void setAppoint_End_Date(java.lang.String) 

    /**
     * Sets the value of field 'appoint_Start_Date'.
     * 
     * @param appoint_Start_Date the value of field
     * 'appoint_Start_Date'.
    **/
    public void setAppoint_Start_Date(java.lang.String appoint_Start_Date)
    {
        this._appoint_Start_Date = appoint_Start_Date;
    } //-- void setAppoint_Start_Date(java.lang.String) 
    ...
    **/
     ...
     * @param reader
    **/
    public static com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1003.req.Request unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1003.req.Request) Unmarshaller.unmarshal(com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1003.req.Request.class, reader);
    } //-- com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1003.req.Request unmarshal(java.io.Reader) 
