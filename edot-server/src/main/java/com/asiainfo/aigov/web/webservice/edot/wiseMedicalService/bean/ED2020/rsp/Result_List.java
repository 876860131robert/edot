...
public class Result_List implements java.io.Serializable {
    ...
    public Result_List() {
        super();
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED2020.rsp.Result_List()
    ...
    **/
     ...
     * 
     * @param hospitalName the value of field 'hisPatientId'.
    **/
     ...
     * 
     * @param hospitalName the value of field 'age'.
    **/
     ...
     * 
     * @param patientId the value of field 'phoneNum'.
    **/
    ...
    **/
     ...
     * @param reader
    **/
    public static com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED2020.rsp.Result_List unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED2020.rsp.Result_List) Unmarshaller.unmarshal(com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED2020.rsp.Result_List.class, reader);
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED2020.rsp.Result_List unmarshal(java.io.Reader) 
