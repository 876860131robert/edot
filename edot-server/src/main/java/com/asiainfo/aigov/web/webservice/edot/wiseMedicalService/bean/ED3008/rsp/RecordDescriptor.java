...
public class RecordDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RecordDescriptor() {
        ...
        //-- _hypertensionFollowupId
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_hypertensionFollowupId", "HypertensionFollowupId", NodeType.Element);
        ...
        handler = (new XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                return target.getHypertensionFollowupId();
            }
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Record target = (Record) object;
                    target.setHypertensionFollowupId( (java.lang.String) value);
                }
                catch (Exception ex) {
        ...
        //-- validation code for: _hypertensionFollowupId
        ...
        //-- _refertoOrgName
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_refertoOrgName", "RefertoOrgName", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Record target = (Record) object;
                return target.getRefertoOrgName();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Record target = (Record) object;
                    target.setRefertoOrgName( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _refertoOrgName
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(200);
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3008.rsp.RecordDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3008.rsp.Record.class;
