...
public class ResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResponseDescriptor() {
        ...
        //-- _inpatient
        desc = new XMLFieldDescriptorImpl(Inpatient.class, "_inpatient", "Inpatient", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Response target = (Response) object;
                return target.getInpatient();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Response target = (Response) object;
                    target.setInpatient( (Inpatient) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _inpatient
        fieldValidator = new FieldValidator();
        desc.setValidator(fieldValidator);
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3003.rsp.ResponseDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3003.rsp.Response.class;
