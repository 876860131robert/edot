...
public class RequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RequestDescriptor() {
        ...
        //-- _infectionReporId
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_infectionReporId", "InfectionReporId", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Request target = (Request) object;
                return target.getInfectionReporId();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Request target = (Request) object;
                    target.setInfectionReporId( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _infectionReporId
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator sv = new StringValidator();
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3013.req.RequestDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3013.req.Request.class;
