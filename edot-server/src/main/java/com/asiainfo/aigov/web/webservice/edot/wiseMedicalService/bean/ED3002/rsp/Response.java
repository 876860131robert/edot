...
public class Response implements java.io.Serializable {
    ...
    private Outpatient _outpatient;

    private Fee _fee;

    private SympList _sympList;

    private DrugList _drugList;
    ...
    public Response() {
        super();
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3002.rsp.Response()
    ...
    /**
     * Returns the value of field 'drugList'.
     * 
     * @return the value of field 'drugList'.
    **/
    ...
    **/
    ...
    /**
     * Returns the value of field 'outpatient'.
     * 
     * @return the value of field 'outpatient'.
    **/
    ...
    **/
    ...
    /**
     * Sets the value of field 'drugList'.
     * 
     * @param drugList the value of field 'drugList'.
    **/
    public void setDrugList(DrugList drugList)
    {
        this._drugList = drugList;
    } //-- void setDrugList(DrugList) 
    ...
    **/
    ...
    /**
     * Sets the value of field 'outpatient'.
     * 
     * @param outpatient the value of field 'outpatient'.
    **/
    public void setOutpatient(Outpatient outpatient)
    {
        this._outpatient = outpatient;
    } //-- void setOutpatient(Outpatient) 
    ...
    **/
     ...
     * @param reader
    **/
    public static com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3002.rsp.Response unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3002.rsp.Response) Unmarshaller.unmarshal(com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3002.rsp.Response.class, reader);
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED3002.rsp.Response unmarshal(java.io.Reader) 
