...
public class RequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RequestDescriptor() {
        ...
        //-- _hospital_Code
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_hospital_Code", "Hospital_Code", NodeType.Element);
        ...
        handler = (new XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                return target.getHospital_Code();
            }
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Request target = (Request) object;
                    target.setHospital_Code( (java.lang.String) value);
                }
                catch (Exception ex) {
        ...
        //-- validation code for: _hospital_Code
        ...
        //-- _pay_Mode
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_pay_Mode", "Pay_Mode", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Request target = (Request) object;
                    target.setPay_Mode( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- _all_Amt
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_all_Amt", "All_Amt", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Request target = (Request) object;
                    target.setAll_Amt( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- _pay_List
        desc = new XMLFieldDescriptorImpl(Pay_List.class, "_pay_List", "Pay_List", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Request target = (Request) object;
                return target.getPay_List();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Request target = (Request) object;
                    target.setPay_List( (Pay_List) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED2026.req.RequestDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.wiseMedicalService.bean.ED2026.req.Request.class;
