...
public class Record_InfoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public Record_InfoDescriptor() {
        ...
        //-- _standard_Code
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_standard_Code", "Standard_Code", NodeType.Element);
        ...
        handler = (new XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                return target.getStandard_Code();
            }
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Record_Info target = (Record_Info) object;
                    target.setStandard_Code( (java.lang.String) value);
                }
                catch (Exception ex) {
        ...
        //-- validation code for: _standard_Code
        ...
        //-- _dept_Introduction
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_dept_Introduction", "Dept_Introduction", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Record_Info target = (Record_Info) object;
                return target.getDept_Introduction();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Record_Info target = (Record_Info) object;
                    target.setDept_Introduction( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _dept_Introduction
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1017.rsp.Record_InfoDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1017.rsp.Record_Info.class;
