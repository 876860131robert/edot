...
public class Record_InfoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public Record_InfoDescriptor() {
        ...
        //-- _app_Operate_Time
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_app_Operate_Time", "App_Operate_Time", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Record_Info target = (Record_Info) object;
                return target.getApp_Operate_Time();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Record_Info target = (Record_Info) object;
                    target.setApp_Operate_Time( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _app_Operate_Time
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(100);
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1008.rsp.Record_InfoDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1008.rsp.Record_Info.class;
