...
public class RecordDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RecordDescriptor() {
        ...
        //-- _isReaded
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_isReaded", "IsReaded", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Record target = (Record) object;
                    target.setIsReaded( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.jkghService.bean.ED7001.rsp.RecordDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.jkghService.bean.ED7001.rsp.Record.class;
