...
public class ResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResponseDescriptor() {
        ...
        //-- _result_Data
        desc = new XMLFieldDescriptorImpl(Result_Data.class, "_result_Data", "Result_Data", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Response target = (Response) object;
                return target.getResult_Data();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Response target = (Response) object;
                    target.setResult_Data( (Result_Data) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _result_Data
        fieldValidator = new FieldValidator();
        desc.setValidator(fieldValidator);
        
    } //-- com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1010.rsp.ResponseDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.mpsService.bean.ED1010.rsp.Response.class;
