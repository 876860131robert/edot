...
public class OrderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OrderDescriptor() {
        ...
        //-- validation code for: _orderSerial
        ...
        //-- _applyTime
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_applyTime", "ApplyTime", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Order target = (Order) object;
                    target.setApplyTime( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _applyTime
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(32);
        ...
        //-- _cardTypeDesc
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_cardTypeDesc", "CardTypeDesc", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Order target = (Order) object;
                    target.setCardTypeDesc( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _cardTypeDesc
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(32);
        ...
        //-- _statusDesc
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_statusDesc", "StatusDesc", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Order target = (Order) object;
                    target.setStatusDesc( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _statusDesc
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(32);
    ...
    } //-- com.asiainfo.aigov.web.webservice.edot.cardService.bean.ED4011.rsp.OrderDescriptor()
    ...
    **/
    ...
    {
        return com.asiainfo.aigov.web.webservice.edot.cardService.bean.ED4011.rsp.Order.class;
