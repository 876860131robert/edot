...
<head>
   ...
   <link rel="stylesheet" href="js/app/navtabs/navtabs.css" type="text/css" />
   <script type="text/javascript">
        ...
        var UserVars = { 
        	id: '<shiro:principal property="id"/>', 
        	code: '<shiro:principal property="code"/>', 
...
<body ng-controller="AppCtrl">
  ...
  <script src="js/app/config.router.js"></script>
  ...
  <script src="js/app/sidebar/sidebar.js"></script>
  <script src="js/app/navtabs/navtabs.js"></script>
